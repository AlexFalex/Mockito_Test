...
public class MessageSenderImpl implements MessageSender {
    ...
    public MessageSenderImpl(GeoServise geoServise, LocalizationService localizationService) {
        this.geoServise = geoServise;
    ...
    public String send(Map<String, String> headers) {
        ...
        if (ipAddress != null && !ipAddress.isEmpty()) {
            Location location = geoServise.byIp(ipAddress);
